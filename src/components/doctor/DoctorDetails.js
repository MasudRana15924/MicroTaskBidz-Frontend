...
const DoctorDetails = ({ doctor }) => {
    ...
    const reviewSubmitHandler = () => {
        ...
        dispatch(createreviews(myForm,loggeduser.token,));
    };
    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-2">
                ...
                {
                    token ? <div className="w-2/4  ml-5">
                        <p className="mb-3 text-start ">Give a review</p>
                        <Rating
                        ...
                        <br />
                        <button class="btn w-full mt-2 bg-fuchsia-600 border-fuchsia-600" onClick={reviewSubmitHandler}>Submit</button>
