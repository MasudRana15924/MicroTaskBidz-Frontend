...
const Task = ({ task }) => {
    ...
    return (
        <div className="border border-gray-100 m-5  rounded h-full shadow-md flex items-center lg:block lg:m-0">
            ...
            <div className="p-5 ">
                ...
                <button className="bg-green-600 h-10 w-full mt-5 mb-5 rounded-md text-white text-xl
