...
const FilterTag = ({title}) => {
    ...
    const style = isSelected ? 'text-slate-600 w-36 h-8  pt-1  text-start font-semibold  mt-1 lg:ml-64' : 'w-36 h-8  pt-1  text-start font-semibold text-slate-600 mt-1 lg:ml-64'
    const handleSelect = () => {
        if (isSelected) {
